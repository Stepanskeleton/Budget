...
public partial class saving : Page
{
    ...
    {
        DifferenseUpdate(ref RetirementAccountPlane, ref RetirementAccountFact, ref RetirementAccountDifference,
            ref RetirementAccountPlaneOld, ref RetirementAccountFactOld, ref RetirementAccountDifferenceOld);
    }
    ...
    {
        DifferenseUpdate(ref InvestmentAccountPlane, ref InvestmentAccountFact, ref InvestmentAccountDifference,
            ref InvestmentAccountPlaneOld, ref InvestmentAccountFactOld, ref InvestmentAccountDifferenceOld);
    }
