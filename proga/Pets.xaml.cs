...
public partial class Pets : Page
{
    ...
    {
       DifferenseUpdate(ref FoodPlane, ref FoodFact, ref FoodDifference, ref FoodPlaneOld, ref FoodFactOld, ref FoodDifferenceOld);
    }
    ...
    {
       DifferenseUpdate(ref MedicinePlane, ref MedicineFact, ref MedicineDifference, ref MedicinePlaneOld, ref MedicineFactOld, ref MedicineDifferenceOld);
    }
    ...
    {
       DifferenseUpdate(ref CarePlane, ref CareFact, ref CareDifference, ref CarePlaneOld, ref CareFactOld, ref CareDifferenceOld);
    }
    ...
    {
       DifferenseUpdate(ref ToysPlane, ref ToysFact, ref ToysDifference, ref ToysPlaneOld, ref ToysFactOld, ref ToysDifferenceOld);
    }
